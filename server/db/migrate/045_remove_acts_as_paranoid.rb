class RemoveActsAsParanoid < ActiveRecord::Migration
  ...
  require 'ftools'
  @models = [ Account, DatabaseInstance, DatabaseInstanceRelationship, Datacenter, HardwareProfile, IpAddress, NetworkInterface, NodeGroup, Node, OperatingSystem, Outlet, Rack, Status, Subnet, Vip, DatacenterRackAssignment, DatacenterVipAssignment, ServiceServiceAssignment, VirtualAssignment, NodeGroupNodeAssignment, NodeGroupNodeGroupAssignment, NodeDatabaseInstanceAssignment, RackNodeAssignment ]
