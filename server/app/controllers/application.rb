...
class ApplicationController < ActionController::Base
  ...
  audit Account, DatabaseInstance, DatabaseInstanceRelationship,
    Datacenter, DatacenterRackAssignment, LbPoolNodeAssignment,
    DatacenterVipAssignment, HardwareProfile,
    IpAddress, NetworkInterface, Node, NodeDatabaseInstanceAssignment,
    NodeGroup, NodeGroupNodeAssignment, LbPool, LbProfile,
    VipLbPoolAssignment, NodeGroupNodeGroupAssignment, OperatingSystem, Outlet, Rack,
    RackNodeAssignment, Status, Subnet, Vip, ServiceServiceAssignment
